...
sangraha_path = "./Data/ai4bharat_sangraha/sangraha_data"
wiki_dump_path = "./Data/wiki_dump/wiki_parquet"
final_data_path = "./Data/training_data_parquet"
...
def english_char_percentage(text):
    ...
    if total_chars == 0:
        return 0.0
    english_chars = sum(
        1 for c in text if c.isalpha() and c.lower() in "abcdefghijklmnopqrstuvwxyz"
    )
...
if __name__ == "__main__":
    ...
    merged_df.to_parquet(
        os.path.join(final_data_path, "all_languages_merged.parquet"), index=False
    )
