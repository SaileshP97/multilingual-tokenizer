...
if __name__ == "__main__":
    ...
    parser.add_argument("--source_model", type=str, default="LingoIITGN/Ganga-2-1B", help="Source Model")
    parser.add_argument("--source_tokenizer", type=str, default="LingoIITGN/Ganga-2-1B", help="Source tokenizer")
    parser.add_argument("--target_tokenizer", type=str, default="./Multiligual_Tokenizer", help="Target tokenizer")
    parser.add_argument("--output_dir", type=str, default="./New_Model", help="Saving Dir")
